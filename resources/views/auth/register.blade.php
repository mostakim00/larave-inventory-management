      ...
      <div class="login-wrapper wd-300 wd-xs-400 pd-25 pd-xs-40 bg-white rounded shadow-base">
        ...
        <form method="POST" action="{{ route('register') }}">
            ...
            <div class="form-group">
                ...
                <x-input id="name" placeholder="Enter Your Name" class="form-control" type="text" name="name" :value="old('name')" required autofocus />
            </div>
            ...
            <div class="mt-4 form-group">
                ...
                <x-input id="email" placeholder="Enter a E-mail Address" class="form-control" type="email" name="email" :value="old('email')" required />
            </div>
            ...
            <div class="mt-4 form-group">
                ...
                <x-input id="password" class="form-control" placeholder="Enter a password"
                                type="password"
                                name="password"
